...
pub fn build_router(state: ApiState) -> Router {
    Router::new()
        ...
        .route(
            ...
            get(crate::narrators::narrators_get),
        )
        .route(
            "/narrators/{narrator_id}/books",
            get(crate::narrators::narrators_books),
        )
        .route("/series", get(crate::series::series_list))
        .route("/series/{series_id}", get(crate::series::series_get))
        .route(
            "/collections",
            get(crate::collections::collections_list).post(crate::collections::collections_create),
        )
        .route(
            "/collections/{collection_id}",
            get(crate::collections::collections_get).patch(crate::collections::collections_patch),
        )
        .route(
        ...
        .route(
            ...
            get(crate::publishers::publishers_books),
        )
        ...
        .route(
            "/asin_learnings/{learning_id}",
            delete(crate::asin_learnings::asin_learnings_delete),
        )
        .route(
