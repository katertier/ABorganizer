...
#[tokio::test]
async fn collections_list_protected() {
    assert_protected("GET", "/collections").await;
}
...
#[tokio::test]
async fn collections_patch_protected() {
    assert_protected("PATCH", "/collections/1").await;
}
...
#[tokio::test]
async fn books_collections_protected() {
    assert_protected("GET", "/books/1/collections").await;
}
